...
//        st.getChildren().add(fd);
    ...
    private void BFS(Vertex source) {
        ...
        playPauseImage.setImage(image);
        st = new SequentialTransition();
        chaneVertexColor(st,source,Color.FORESTGREEN);
        source.minDistance = 0;
        source.visited = true;
        ...
        while (!q.isEmpty()) {
            ...
            chaneVertexColor(st,u,Color.CHOCOLATE);
            ...
            chaneVertexColor(st,u,Color.BLUEVIOLET);
        }
    ...
    private void chaneVertexColor(SequentialTransition st, Vertex v, Color color) {
